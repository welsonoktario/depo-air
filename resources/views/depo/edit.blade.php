      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <form class="p-6 bg-white border-b border-gray-200" action="{{ route('depo.update', $depo->id) }}"
          ...
          <div class="mb-3 w-full">
            ...
            <x-input value="{{ $depo->lokasi->latitude }}" name="depo_lokasi_lat" type="text" required />
          </div>
          <div class="mb-6 w-full">
            <x-label for="depo_lokasi_long">Lokasi Depo (Long)</x-label>
            <x-input value="{{ $depo->lokasi->longitude }}" name="depo_lokasi_long" type="text" required />
          </div>
          <div class="mb-6 w-full">
